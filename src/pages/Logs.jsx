...
export default function Logs() {
  ...
  const [selectedDate, setSelectedDate] = useState(''); // 'YYYY-MM-DD' (empty defaults to showing the current week)
  ...
  const processExport = (dataToExport) => {
    ...
    const filename = exportType === 'day' ? `WUP-VisitorLogs_${exportDayValue}.xlsx` : `VisitorLogs_${exportMonthValue}.xlsx`;
